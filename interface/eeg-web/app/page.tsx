...
const teamMembers = [
  {
    ...
    role: "Team Leader and Scrum Master",
  ...
  {
    name: "Neeti Mistry",
    role: "Back-End Dev and Documentation",
    svg: "M8.25 7.5V6.108c0-1.135.845-2.098 1.976-2.192.373-.03.748-.057 1.123-.08M15.75 18H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08M15.75 18.75v-1.875a3.375 3.375 0 0 0-3.375-3.375h-1.5a1.125 1.125 0 0 1-1.125-1.125v-1.5A3.375 3.375 0 0 0 6.375 7.5H5.25m11.9-3.664A2.251 2.251 0 0 0 15 2.25h-1.5a2.251 2.251 0 0 0-2.15 1.586m5.8 0c.065.21.1.433.1.664v.75h-6V4.5c0-.231.035-.454.1-.664M6.75 7.5H4.875c-.621 0-1.125.504-1.125 1.125v12c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V16.5a9 9 0 0 0-9-9Z"
  },
  {
    name: "Sara Gaber",
    role: "Lead Developer",
    ...
    <main>
      ...
      <div className="">
          ...
          <div className="hero-content text-center text-neutral-content">
            <div className="max-w-2xl">
              <h1 className="mb-5 text-5xl font-bold">
                Brain-Computer Interface (BCI): SSW-555
              </h1>
              <p className="mb-5">
        ...
        <Title title="About the Team">
          We had an excellent team of 6! Here&apos;s some more about them and their
          roles in this project.
        </Title>
        <div className="grid grid-cols-3 p-5 gap-5 gap-y-10 justify-items-stretch">
          {teamMembers.map((member, index) => (
            <div key={index}>
              <Jobcard name={member.name} svg={member.svg}>
                {member.role}
              </Jobcard>
            </div>
          ))}
